...
import 'ver_produto_tablet_model.dart';
export 'ver_produto_tablet_model.dart';
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: Padding(
            padding: EdgeInsetsDirectional.fromSTEB(250.0, 20.0, 0.0, 0.0),
            child: Text(
                        ...
                        children: [
                          Padding(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                if (functions.slQuantidadeMaiorQueUm(
                                    _model.quantidade)!) {
