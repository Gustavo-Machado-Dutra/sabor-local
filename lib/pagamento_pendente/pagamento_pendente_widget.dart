                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Abra o link seguro e volte aqui para verificar a confirmacao.',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    font: GoogleFonts.inter(
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        if (FFAppState().id_pagamento_asaas == '') {
                          ...
                          if ((_model.statusPagamentoConsultado?.succeeded ??
                              true)) {
                            if (PagamentoStatusResponseStruct.maybeFromMap((_model.statusPagamentoConsultado?.jsonBody ?? ''))?.status ==
                                'CONFIRMED') {
                              FFAppState().status_pagamento =
                                  'Pagamento aprovado';
                              safeSetState(() {});
                              ...
                              context
                                  .pushNamed(SucessoPagamentoWidget.routeName);
                      ...
                      options: FFButtonOptions(
                        ...
                        iconPadding:
                            EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 0.0),
                        iconColor: Color(0xFF171616),
                        color: FlutterFlowTheme.of(context).tertiary,
                        textStyle: TextStyle(
                          color: Color(0xFF171615),
                        ),
                        borderRadius: BorderRadius.circular(8.0),
                      ),
                    ),
