...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    saborLocalAuthUserSubject.add(
      SaborLocalAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SaborLocalAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SaborLocalAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SaborLocalAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    saborLocalAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
SaborLocalAuthUser? currentUser;
