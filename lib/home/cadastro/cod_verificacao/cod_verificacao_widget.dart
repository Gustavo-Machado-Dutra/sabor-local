...
import 'cod_verificacao_model.dart';
export 'cod_verificacao_model.dart';

class CodVerificacaoWidget extends StatefulWidget {
  const CodVerificacaoWidget({super.key});

  static String routeName = 'CodVerificacao';
  static String routePath = '/codVerificacao';

  @override
  State<CodVerificacaoWidget> createState() => _CodVerificacaoWidgetState();
}

class _CodVerificacaoWidgetState extends State<CodVerificacaoWidget>
    with TickerProviderStateMixin {
  late CodVerificacaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CodVerificacaoModel());
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.codigoAdressTextController,
                                  ...
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if ((_model.apiResultValidarOTP
                                                ?.succeeded ??
                                            true)) {
                                          context.pushNamed(
                                              EnderecoCopyWidget.routeName);
                                        } else {
                                          await showDialog(
                                            context: context,
                                            builder: (alertDialogContext) {
