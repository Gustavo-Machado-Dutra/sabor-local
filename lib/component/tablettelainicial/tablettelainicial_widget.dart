...
import 'tablettelainicial_model.dart';
export 'tablettelainicial_model.dart';

class TablettelainicialWidget extends StatefulWidget {
  const TablettelainicialWidget({super.key});

  @override
  State<TablettelainicialWidget> createState() =>
      _TablettelainicialWidgetState();
}

class _TablettelainicialWidgetState extends State<TablettelainicialWidget>
    with TickerProviderStateMixin {
  late TablettelainicialModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TablettelainicialModel());
