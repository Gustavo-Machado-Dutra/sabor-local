...
import 'codverificacaotablet_model.dart';
export 'codverificacaotablet_model.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              ...
              child: Padding(
                padding:
                    EdgeInsetsDirectional.fromSTEB(16.0, 200.0, 16.0, 16.0),
                child: Column(
                  mainAxisSize: MainAxisSize.max,
                  ...
                  children: [
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(5.0, 30.0, 0.0, 15.0),
                      child: Text(
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(5.0, 0.0, 0.0, 30.0),
                      child: Text(
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          validator: _model.codigoAdressTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
