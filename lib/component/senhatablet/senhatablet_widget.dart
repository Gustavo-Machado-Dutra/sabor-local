...
import 'senhatablet_model.dart';
export 'senhatablet_model.dart';
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          validator: _model.senhaAdressTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                    Padding(
                      ...
                      child: Container(
                        width: double.infinity,
                        child: TextFormField(
                          controller: _model.confirmarSenhaAdressTextController,
                          focusNode: _model.confirmarSenhaAdressFocusNode,
                          autofocus: false,
                          autofillHints: [AutofillHints.telephoneNumber],
                          obscureText: !_model.confirmarSenhaAdressVisibility,
                          decoration: InputDecoration(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            _model.cadastroXanoSalvo =
                              ...
                              _model.confirmarSenhaAdressTextController.text,
                            );
                            if (_model.cadastroXanoSalvo == true) {
                              context.pushNamed(CodVerificacaoWidget.routeName);
                            } else {
