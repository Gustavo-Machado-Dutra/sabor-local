...
class ImagemStruct extends BaseStruct {
  ImagemStruct({
    String? access,
    String? path,
    String? name,
  ...
  static ImagemStruct fromMap(Map<String, dynamic> data) => ImagemStruct(
  ...
  static ImagemStruct? maybeFromMap(dynamic data) =>
      data is Map ? ImagemStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static ImagemStruct fromSerializableMap(Map<String, dynamic> data) =>
      ImagemStruct(
  ...
  @override
  String toString() => 'ImagemStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ImagemStruct &&
        access == other.access &&
        path == other.path &&
        name == other.name &&
        type == other.type &&
...
ImagemStruct createImagemStruct({
  String? access,
  String? path,
  String? name,
  String? type,
